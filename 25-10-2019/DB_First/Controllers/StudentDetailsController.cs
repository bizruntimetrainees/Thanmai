...
namespace DB_First.Controllers
{
    ...
    {
        private readonly BizruntimeContext _context;

        public StudentDetailsController(BizruntimeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StudentId,FirstName,LastName,Age,Gender,Batch,Address,Class,School,Domicile,Id")] StudentDetails studentDetails)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,FirstName,LastName,Age,Gender,Batch,Address,Class,School,Domicile,Id")] StudentDetails studentDetails)
        {
